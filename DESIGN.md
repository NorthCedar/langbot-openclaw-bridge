...
### ✅ 方案 5：wechatbot-webhook（web 微信协议）— 待验证
...
- PR #5（GeWeChat 版）代码需重写为 wechatbot-webhook 版
- Node.js v22.22.2 可用

## 下一步

1. 部署 wechatbot-webhook Docker
2. 确认小号能登录 web 微信
3. 验证群消息 webhook 结构
4. 重写 Bridge 对接 wechatbot-webhook 的 payload 格式
5. 端到端联调
